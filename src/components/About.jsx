...
const ServiceCard = ({ index, title, icon }) => {
  ...
  return (
    <div ref={cardRef} className="xs:w-[250px] w-full">
      <div className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card spin-y-on-hover" style={{ perspective: '1000px' }}>
...
const About = () => {
  ...
  return (
    <>
      ...
      <ul ref={paragraphRef} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px] list-disc list-inside">
       <li>Skilled Machine Learning Practitioner and Full Stack Developer with experience in Python, React, and data-driven development.</li>
        ...
        <br></br>I'm a quick learner who collaborates closely with clients to craft efficient, scalable, and user-friendly 
        solutions—whether that means building interactive web applications or training ML models to solve complex problems. 
        <br></br>Let's work together to bring your ideas to life with the power of both code and data!
      </ul>
